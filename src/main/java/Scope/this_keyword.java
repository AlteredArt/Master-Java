...
// variables with the same name as instance variables. For example, 
...
//   }
// }
// We have an instance variable named name, but the method speakNewName has 
// a parameter named name. So when the method tries to print name, which 
// variable will be printed? By default, Java refers to the local variable 
// name. So in this case, the value passed to the parameter will be printed 
...
// convention, it can also be confusing. There’s nothing wrong with naming 
// your parameters something else to be more clear. Sometimes you will see 
// something like:

// public Dog(String inputName){
//   this.name = inputName;
// }
// This is now a little clearer — we’re setting the Dog‘s instance variable 
// name equal to the name we give the constructor.
...
// local variable with the same name, Java will know to use the instance 
// variable with that name. That being said, it is a good habit to use this. 
