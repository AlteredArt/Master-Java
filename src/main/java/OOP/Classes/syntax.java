...
// our screen, but we also need to write our own classes for the custom needs of a program.
...
// allows other classes to interact with this class. For now, all classes will be public.

// This class has a main() method, which lists the tasks performed by the program. main() 
