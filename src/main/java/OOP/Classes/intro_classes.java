...
// For example, a program to track student test scores might have Student, Course, and 
// Grade classes. Our real-world concerns, students and their grades, are inside the 
// program as classes.

// We represent each student as an instance, or object, of the Student class.

// This is object-oriented programming because programs are built around objects and 
// their interactions. An object contains state and behavior.
...
// An instance is the thing itself. This student has an ID of 42, this course enrolled 
// that student, etc.
...
// They share behavior (how they deposit and withdraw) but have individual state (their 
// balances), and even with the same balance amount these accounts are separate entities.
