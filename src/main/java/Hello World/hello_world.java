...
// Programming languages enable humans to write instructions that 
// a computer can perform. With precise instructions, computers coordinate 
// applications and systems that run the modern world.
...
// Java understands. We write syntax in files to create programs, which are executed 
