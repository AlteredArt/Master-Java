...
// // prints false
// Side note, there’s also an equalsIgnoreCase() method that compares 
// two strings without considering upper/lower cases.

// Keep Reading: AP Computer Science A Students

// We can also compare String values lexicographically (think dictionary 
// order) using the .compareTo() method. When we call the .compareTo() 
// method, each character is in the String is converted to Unicode; then 
// the Unicode character from each String is compared.

// The method will return an int that represents the difference between 
// the two Strings.
...
// differ by 3). If we did flavor2.compareTo(flavor1), we would get 3, 
// signifying that "Peach" is greater than "Mango".
...
// when comparing "Mango" and "Peach", we got -3, meaning that "Mango" was smaller. 
// But if we compare "mango" and "Peach" we get 29. The Unicode value for lower 
// case "m" is actually larger than upper case "P". Using .compareToIgnoreCase() 
...
public class Password {
  ...
  public static void main(String[] args) {
    ...
    // Write the code:
    System.out.println(password.equals("hello"));
