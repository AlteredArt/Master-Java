...
// and then reassigns its value. Using the += compound assignment operator, we 
// can rewrite our previous code like so:
...
// A customer comes and buys 3 cookies. Use the appropriate compound assignment 
