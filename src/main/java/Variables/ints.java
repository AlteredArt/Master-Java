...
// The first type of data we will store is the whole number. Whole numbers 
// are very common in programming. You often see them used to store ages, 
// or maximum sizes, or the number of times some code has been run, among 
// many other uses.
...
// To declare a variable of type int, we use the int keyword before the 
// variable name:
