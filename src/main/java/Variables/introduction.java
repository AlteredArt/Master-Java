...
// The value 42 could be someone’s age, a weight in pounds, or the number 
// of orders placed. With a name, we know the value 42 is age, weightInPounds, 
// or numOrdersPlaced.

// In Java, we specify the type of information we’re storing. Primitive datatypes 
// are types of data built-in to the Java system. The three main primitive types 
// we’ll cover are int, double, and boolean; this lesson will introduce these 
// built-in types and more.
